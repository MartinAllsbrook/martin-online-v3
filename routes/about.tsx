        ...
        <div class="">
            <PageWrap head = {{ title: "About - Martin Allsbrook" }} index={[{ name: "back", href: "./" }]} route={[ { name: "about", href: "./about" } ]}>
                ...
                <div class="flex flex-col sm:flex-row">
                    <img class="hidden sm:block sm:w-1/3 mr-4" src={`${data?.payloadUrl}${data?.image?.url}`} alt={data?.image?.alt} />
                    ...
                    <img class="sm:hidden" src={`${data?.payloadUrl}${data?.image?.url}`} alt={data?.image?.alt} />
                </div>
            </PageWrap>
        </div>
    );
